...
const Home = () => {
  ...
  const categories = [
    { icon: <i className="fa-solid fa-user-tie fa-2xl"></i>, name: "Men's Fashion" },
    { icon: <i className="fa-solid fa-shirt fa-2xl"></i>, name: "Casual Wear" },
    { icon: <i className="fa-solid fa-glasses fa-2xl"></i>, name: "Accessories" },
    { icon: <i className="fa-solid fa-socks fa-2xl"></i>, name: "Winter Wear" },
    { icon: <i className="fa-solid fa-shoe-prints fa-2xl"></i>, name: "Footwear" },
  ];

  const testimonials = [
    { id: 1, content: "Great products and fast delivery! Lorem ipsum.", author: "John Doe" },
    { id: 2, content: "Amazing quality and stylish items. Lorem ipsum.", author: "Jane Smith" },
    { id: 3, content: "Best online shopping experience. Lorem ipsum.", author: "Alex Brown" },
  ];
  ...
  return (
    <HomeContainer>
      ...
      <FeaturedProductsSection>
        ...
        <ProductSlider dots={true} infinite={true} speed={800} autoplay={true} slidesToShow={3} slidesToScroll={1}>
      ...
      {/* Deals of the Month */}
      <DealsSection>
        <SectionTitle>Deals of the Month</SectionTitle>
        <p>Unbeatable discounts on top products. Limited time only!</p>
        <ProductSlider dots={true} infinite={true} speed={700} autoplay={true} slidesToShow={3} slidesToScroll={1}>
